...
public class ExclusionPatternCollectionResourceTests {
    ...
    @Before
    public void setUp() {
        subscription = new Subscription(new User(TestUser.USER4.email), new Feed("http://localhost", "title"));
        subscription.setId(1L);
        given(subscriptionRepository.findByIdAndUserId(109L, TestUser.USER4.id))
    ...
    public void shouldReturnNotFound() throws Exception {
        given(subscriptionRepository.findByIdAndUserId(1L, TestUser.USER2.id))
