...
public class SubscriptionEntityResource {
    ...
    @ModelAttribute
    Subscription find(@PathVariable("id") Long id, @AuthenticationPrincipal MyReaderUser user) {
    ...
    public SubscriptionGetResponse get(@PathVariable("id") Long id, Subscription s) {
        return resourceAssemblers.toResource(s, SubscriptionGetResponse.class);
    }
