import {componentMock, multipleReactComponents, onKey, tick} from '../../../../shared/test-utils'
...
describe('src/app/js/shared/component/autocomplete-input/autocomplete-suggestions/autocomplete-suggestions.component.spec.js', () => {
  ...
  let page, scope, autoScroll, autocompleteItemTexts

  beforeEach(() => {
    autocompleteItemTexts = multipleReactComponents('AutocompleteItemText')
    autoScroll = componentMock('myAutoScroll')
    angular.mock.module('myreader', autoScroll, autocompleteItemTexts)
  })
  ...
  it('should pass search term to item text components', () => {
    ...
    expect(autocompleteItemTexts.bindings[2]).toContainObject({term: 'term1', termFragment: 'ter'})
    expect(autocompleteItemTexts.bindings[3]).toContainObject({term: 'term2', termFragment: 'ter'})
  })
  ...
  it('should pass changed search term to item text components', () => {
    ...
    expect(autocompleteItemTexts.bindings[2]).toContainObject({term: 'term1', termFragment: 'term1'})
  })
